...
generation service built around the discipline that matters in production: every change is gated by
...
The graph is genuinely agentic: from a real retrieval-confidence signal and an LLM sufficiency check,
...
The evaluation harness ([`evals/`](evals/)) is the centrepiece.
